...
conn = sqlite3.connect("ded_database.db")
c = conn.cursor()
        ...
        if date:
            ...
            if old_file_email_len > 0:
                ...
                if date <= old_file_info[0].get("date"):
                    ...
                    c.execute(f"""INSERT INTO file_info VALUES ('{file_id}', '{email_id}', '{date}', '{text_resume_hash}', '{given_family_code}', '{created_time}', '{months_of_work}')""")
                    conn.commit()
            ...
            if old_file_email_len > 0:
                ...
                elif created_time == old_file_info[0].get("createdTime"):
