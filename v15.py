...
newDatasetPath = r"/home/izoom/BIG_LOCAL_DISKS/datasetv15"
...
conn = sqlite3.connect("testv15.db", isolation_level=None)
...
with open('seenv15.txt', 'r') as file:
